        ...
        <footer className="page-footer">
            <div className="row">
                <div className="footer-about">
                    <h2 className="footer-about">About</h2>
                    <p>An exercise for Solita Dev Academy 2022.
                    Solita has received an interesting project offer to create 
                    a UI and a backend for displaying data from different farms.
                    </p>
                </div>
                <div className="footer-contact">
                    <h2 className="footer-contact">Contact</h2>
                    <p>Anne Ruohonen
                        <br/>anne.s.ruohonen@gmail.com 
