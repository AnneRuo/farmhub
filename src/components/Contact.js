...
const Contact = () => {
  return (
    <div>
      ...
      <p>
        The next step is to start a new career as a developer and continue
        learning on the job.
      </p>

      <p>
        You can find my other projects on{' '}
        <a href="https://github.com/AnneRuo?tab=repositories">GitHub</a> and get
        to know me and my skills better on my{' '}
